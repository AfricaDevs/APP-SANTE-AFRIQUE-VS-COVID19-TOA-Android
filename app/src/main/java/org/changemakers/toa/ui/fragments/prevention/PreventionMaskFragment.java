...
import org.changemakers.toa.databinding.FragmentPreventionMaskBinding;

import java.util.ArrayList;

public class PreventionMaskFragment extends BottomSheetDialogFragment implements View.OnClickListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private FragmentPreventionMaskBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = FragmentPreventionMaskBinding.inflate(getLayoutInflater());

        mTitles = getResources().getStringArray(R.array.prevention_mask_options_titles);

        binding.backArrow.setOnClickListener(this);

        mViewPagerAdapter = new PagerAdapter(getChildFragmentManager(), BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);

        mViewPagerAdapter.addFragment(new PreventionMaskWhyFragment());
        mViewPagerAdapter.addFragment(new PreventionMaskWhenFragment());
        mViewPagerAdapter.addFragment(new PreventionMaskHowFragment());
